...
def passes_filter(row):
    ...
    elif row['qSiteInfo'] != "Sidewalk: Curb side : Yard" and row['qSiteInfo'] != "Back Yard : Yard" and row['qSiteInfo'] != "Sidewalk: Curb side : Cutout" and row['qSiteInfo']!="Sidewalk: Curb side : Pot":
        return False
    else:
        return True
...
# export to new CSV       
with open('Street_Tree_List-2022-01-30_SITEINFO.csv','w') as f:
